      ...
      <div className="container mx-auto px-4">
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="flex items-center gap-2 hover:opacity-90 transition-opacity mb-6 inline-block">
              <div className="bg-white px-3 py-2 rounded-xl inline-block shadow-lg">
                <img src="/logo.png" alt="Lending Loan Club" className="h-24 w-auto object-contain" />
              </div>
            </Link>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:support@lendingloanclub.com" className="text-white hover:text-accent font-semibold transition-colors">support@lendingloanclub.com</a>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-white/80 text-sm space-y-2 mt-1">
                    <div>
                      ...
                      15303 Ventura Blvd, Suite 850, Sherman Oaks, California 91403, United States
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="border-t border-white/10 pt-8 mt-12">
          <div className="text-xs text-white/40 leading-relaxed mb-6 space-y-4">
            ...
            <p>
              Lending Loan Club does not act as a lender in all instances, but rather as a marketplace to connect borrowers with participating lenders.
            </p>
          </div>
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-white/50 border-t border-white/10 pt-6">
            <p>&copy; {new Date().getFullYear()} Lending Loan Club. All rights reserved.</p>
