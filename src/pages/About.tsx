        ...
        <section className="relative overflow-hidden pt-20 pb-32" style={{ background: "hsl(216 68% 12%)" }}>
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            <h1 className="text-5xl md:text-7xl font-black text-white mb-6" style={{ fontFamily: "'Poppins', sans-serif" }}>
              About <span className="text-transparent bg-clip-text" style={{ backgroundImage: "linear-gradient(135deg, hsl(160 60% 45%), hsl(38 92% 50%))" }}>Lending Loan Club</span>
            </h1>
        ...
        <section className="bg-gray-50 py-24 border-t border-gray-100">
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="text-center mb-16 max-w-3xl mx-auto">
              ...
              <p className="text-lg text-gray-500">
                The dedicated professionals behind Lending Loan Club working to secure your financial future.
              </p>
            </div>
